...
You can donate by contacting my owner: [https://t.me/+0y8WgOGApxlhNjE1)
     """
...
async def start(c: Gojo, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        try:
            cpt = f"""
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! I am Group Manger ✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](https://t.me/+0y8WgOGApxlhNjE1) to get information on all the latest updates."""
...
async def commands_menu(_, q: CallbackQuery):
    ...
    try:
        cpt = f"""
Hey **[{q.from_user.first_name}](http://t.me/{q.from_user.username})**! I am Group Manger✨.
I'm here to help you manage your group(s)!
Commands available:
× /start: Start the bot
...
async def help_menu(_, m: Message):
    if len(m.text.split()) >= 2:
        ...
        if m.chat.type == ChatType.PRIVATE:
            ...
            keyboard = ikb(ou, True)
            msg = f"""
Hey **[{m.from_user.first_name}](http://t.me/{m.from_user.username})**!I am Group Manager✨.
I'm here to help you manage your group(s)!
Commands available:
× /start: Start the bot
× /help: Give's you this message."""
